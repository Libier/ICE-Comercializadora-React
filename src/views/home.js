...
const Home = (props) => {
  return (
    <div className="home-container1">
      <Helmet>
        <title>ICE Comercializadora</title>
        <meta property="og:title" content="ICE Comercializadora" />
      </Helmet>
        ...
        <header data-role="Header" className="home-header max-width-container">
          <div className="home-navbar2">
            ...
            <div className="home-middle1">
              <span className="navbar-logo-title">ICE COMERCIALIZAADORA</span>
          ...
          <div data-role="MobileMenu" className="home-mobile-menu">
            <div className="home-nav">
              ...
              <div className="home-middle2">
                ...
                <span className="home-text13">LOOKBOOK</span>
                <span className="home-text14">SPECIAL</span>
          ...
          <div className="home-max-width1 max-width-container">
            <div className="home-hero2">
              <div className="home-container4">
                <h1 className="home-text18 Heading-1">QUOTING SYSTEM</h1>
        ...
        <div className="max-width-container">
          <footer className="home-footer2">
            <div className="home-container6">
              <h3 className="home-text19 Heading-3">ICE Comercializadora</h3>
              <span className="home-text20">
                <span>Guadalupe Victoria 170-A</span>
                <br></br>
                <span>Col. Moderna</span>
                <br></br>
                <span>Empalme, Sonora</span>
                <br></br>
              </span>
              <span className="home-text27">
                <span>(622) 113-0383</span>
                <br></br>
              </span>
              <span className="home-text30">
                ventas@icecomercializadora.com
              </span>
            </div>
            <div className="home-links-container">
              <div className="home-container7">
                <span className="home-text31">Categorías</span>
                <span className="home-text32">Panel Térmico</span>
                <span className="home-text33">Puertas Vaivén</span>
                <span className="home-text34">Puertas Reach-in</span>
                <span className="home-text35">Cerrojos y Bisagras</span>
                <span className="home-text36">Molduras</span>
                <span className="home-text37">Misceláneos</span>
              </div>
              <div className="home-container8">
                <span className="home-text38">Companía</span>
                <span className="home-text39">Cotizaciones</span>
                <span className="home-text40">About</span>
              </div>
              <div className="home-container9">
                <span className="home-text41">Recursos</span>
                <span className="home-text42">Contáctanos</span>
                <span className="home-text43">Órden de Compra</span>
                <span className="home-text44">Seguimiento a Envíos</span>
              </div>
            </div>
          </footer>
        </div>
